...
_Main.main$AS = function (args) {
	...
	jq = (function (v) {
		if (! (v == null || typeof v === "function")) {
			debugger;
			throw new Error("[public/javascripts/client.jsx:6] detected invalid cast, value is not a function or null");
		}
		return v;
	}(js.global.$));
	JQ = js.global.$;
	jq((function () {
		jq("#button").click((function (event) {
			JQ.get(dom.window.location.href + "data", null, (function (data) {
...
dom.createElement$S = function (tag) {
	return (function (v) {
		if (! (v == null || v instanceof HTMLElement)) {
			debugger;
			throw new Error("[/usr/local/lib/node_modules/jsx/lib/js/js/web.jsx:45] detected invalid cast, value is not an instance of the designated type or null");
		}
		return v;
...
$__jsx_lazy_init(dom, "document", function () {
	return (function (v) {
		if (! (v == null || v instanceof HTMLDocument)) {
			debugger;
			throw new Error("[/usr/local/lib/node_modules/jsx/lib/js/js/web.jsx:23] detected invalid cast, value is not an instance of the designated type or null");
		}
		return v;
	}(js.global.document));
});
...
function $__jsx_onload (event) {
	...
	JSX.runMain("public/javascripts/client.jsx", [])
}
